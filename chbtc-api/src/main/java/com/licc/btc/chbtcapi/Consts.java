...
public class Consts {
    ...
    public static final String Chbtc_Trade             = "https://trade.zb.com/api/";
    public static final String Chbtc_Data            = "http://api.zb.com/data/v1/";

    /*************************** 接口方法 *******************/
    public static final String Chbtc_Data_Tticker       = "ticker";                        //行情
